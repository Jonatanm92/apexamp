...
inline std::vector<Preset> factory()
{
    return {
        { "Init", {
            ...
            { "sag", 0.3f }, { "powerDrive", 0.3f }, { "gate", -60.0f }, { "cabOn", 1.0f }, { "master", -3.0f }
        }},
        { "Chug Machine", {
            ...
            { "sag", 0.4f }, { "powerDrive", 0.5f }, { "gate", -42.0f }, { "cabOn", 1.0f }, { "master", -3.0f }
        }},
        { "Djent Tight", {
            { "channel", 1 }, { "tonestack", 3 }, { "inputTrim", 0.0f },
            ...
            { "sag", 0.35f }, { "powerDrive", 0.5f }, { "gate", -38.0f }, { "cabOn", 1.0f }, { "master", -3.0f }
        }},
        { "Modern Lead", {
            ...
            { "sag", 0.55f }, { "powerDrive", 0.6f }, { "gate", -52.0f }, { "cabOn", 1.0f }, { "master", -3.0f }
        }},
        { "Tight Rhythm (Marshall)", {
            ...
            { "sag", 0.35f }, { "powerDrive", 0.45f }, { "gate", -46.0f }, { "cabOn", 1.0f }, { "master", -3.0f }
        }},
        { "Clean (Fender)", {
            ...
            { "chug", 0.0f }, { "lowDirtDrive", 0.0f }, { "lowDirtMix", 0.0f },
            { "sag", 0.2f }, { "powerDrive", 0.2f }, { "gate", -68.0f }, { "cabOn", 1.0f }, { "master", -3.0f }
        }},
    };
}
